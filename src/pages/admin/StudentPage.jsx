...
const StudentPage = () => {
    ...
    const toggleStudentStatus = async (student) => {
        ...
        try {
            ...
            setError(
                err.message ||
                `Unable to ${action} student account.`
            );
        }
    };
                                                    ...
                                                    <td className="px-5 py-5">
                                                        <div className="flex justify-end gap-2">
                                                            ...
                                                            <button
                                                                ...
                                                                className={`flex h-8 w-8 items-center justify-center rounded-lg transition ${active
                                                                        ? "text-slate-400 hover:bg-red-50 hover:text-red-500"
                                                                        : "text-[#007979] hover:bg-[#D9FFF4]"
                                                                    }`}
                                                            >
                                                                <FaEllipsisV />
                                                            </button>
                                        ...
                                        >
                                            ...
                                            <div className="mt-4 flex gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`flex h-10 w-10 items-center justify-center rounded-lg transition ${active
                                                            ? "text-slate-400 hover:bg-red-50 hover:text-red-500"
                                                            : "text-[#007979] hover:bg-[#D9FFF4]"
                                                        }`}
                                                >
