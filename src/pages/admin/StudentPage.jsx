...
import { FaEllipsisV, FaPlus, FaSearch, FaUserCheck, FaUserCog, FaChartLine } from "react-icons/fa";

import { createStudent, disableStudent, enableStudent, getStudents, updateStudent } from "../../api/students";
...
const StudentPage = () => {
    ...
    const toggleStudentStatus = async (student) => {
        ...
        if (!window.confirm(`${action} ${studentName}?`)) {
            return;
        }
        ...
        try {
            if (active) {
                ...
                setSuccess("Student account reactivated successfully.");
            }
    
            await loadStudents();
        } catch (err) {
            setError(err.message || `Unable to ${action} student.`);
        }
    };
    ...
    const reactivateStudent = async (student) => {
        ...
        try {
            ...
            setError(err.message || "Unable to reactivate student.");
        }
    };
